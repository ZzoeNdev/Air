...
<body>
        ...
        <header>
            ...
            <div>
                <a href="../Cadastro/cadastro.php"><button class="cadastro">Não tem cadastro?</button></a>
            </div>
    ...
    <form method="POST">
        ...
        <br>
        <input class="text" type="password" name="senha" id="senha" placeholder="Sua senha">
        <br>
        <input type="checkbox" id="checkbox" onclick="mostrarSenha()">
        <label for="checkbox">Mostrar senha</label>

        <script src="scrptlogin.js"></script>
        <br><br>
        <?php
        ...
        // Exclusão de conta
            ...
            if (isset($_POST['submit_conta']))
            {
                ...
                $conta = mysqli_query($conexao, "INSERT INTO cadastrar(email,senha,nome,telefone,confirmado) VALUES ('teste@air.com','t','Conta Teste','11 9602 8922',1)");
                echo '<p style = "color: green; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">';
